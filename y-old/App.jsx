...
const Textarea = ({ className, inputGradient, ...props }) => {
  ...
  return (
    <textarea
      className={cn(
        "flex w-full rounded-md border border-gray-600 bg-gray-800 px-3 py-2 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900",
        className
      )}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="mb-6 w-full max-w-[400px] mx-auto">
              ...
              <TabsTrigger tabValue="settings" value={activeTab} onValueChange={setActiveTab} variant="gradientReverse">
                <span className="material-icons mr-2">settings</span> Admin
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center">
                      <span className="material-icons text-blue-400 mr-3">calendar_today</span>
                      {calendarId ? (
                        <p className="text-white">Using calendar: Schedularr ({calendarId})</p>
                      ) : (
                    ...
                    <div className="flex items-center">
                      <span className="material-icons text-blue-400 mr-3">share</span>
                      <div className="w-full">
                        <Input
                          value={shareEmail}
                    ...
                    <div className="flex items-center">
                      <span className="material-icons text-blue-400 mr-3">palette</span>
                      <select
                        value={inputGradient}
                        onChange={handleInputGradientChange}
                        className="flex h-10 w-full rounded-md border border-gray-600 bg-gray-800 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                      >
                    ...
                    <div className="flex items-center">
                      <span className="material-icons text-blue-400 mr-3">timer</span>
                      <select
