...
const Input = ({ className, inputGradient, ...props }) => {
  const gradientStyles = {
    ...
    'purple-gold': '0 0 10px rgba(128, 0, 128, 0.5), 0 0 20px rgba(255, 215, 0, 0.5)',
  };
  const hoverGradientStyles = {
    ...
    'purple-gold': '0 0 15px rgba(128, 0, 128, 0.7), 0 0 25px rgba(255, 215, 0, 0.7)',
  };
  return (
...
const Button = ({ className, variant = "default", inputGradient, ...props }) => {
  ...
  const variants = {
    ...
    share: inputGradient === "grey-yellow" ? "bg-gradient-to-r from-grey-500 to-yellow-600 text-white hover:from-grey-600 hover:to-yellow-700 focus:ring-yellow-500 transform hover:scale-105" :
           ...
           inputGradient === "dark-grey" ? "bg-gradient-to-r from-grey-700 to-grey-800 text-white hover:from-grey-800 hover:to-grey-900 focus:ring-grey-500 transform hover:scale-105" :
           ...
           inputGradient === "white-mode" ? "bg-gradient-to-r from-white-500 to-grey-300 text-black hover:from-white-600 hover:to-grey-400 focus:ring-white-500 transform hover:scale-105" :
           inputGradient === "purple-gold" ? "bg-gradient-to-r from-purple-500 to-yellow-600 text-white hover:from-purple-600 hover:to-yellow-700 focus:ring-purple-500 transform hover:scale-105" :
...
const CardTitle = ({ className, inputGradient, ...props }) => {
  const gradientStyles = {
    'grey-yellow': 'bg-gradient-to-r from-grey-300 to-yellow-500 bg-clip-text text-transparent',
    ...
    'dark-grey': 'bg-gradient-to-r from-grey-500 to-grey-700 bg-clip-text text-transparent',
    ...
    'white-mode': 'bg-gradient-to-r from-grey-300 to-white-500 bg-clip-text text-transparent',
    'purple-gold': 'bg-gradient-to-r from-purple-400 to-yellow-500 bg-clip-text text-transparent',
  };
  return (
    <h3
      className={cn(
...
const Alert = ({ className, variant = "default", inputGradient, onDismiss, ...props }) => {
  ...
  return (
    <div
      ...
      className={cn(
        baseStyles,
        variant === "success" ? (inputGradient === "grey-yellow" ? "bg-gradient-to-r from-grey-500 to-yellow-600" :
                                 inputGradient === "green-cyan" ? "bg-gradient-to-r from-green-500 to-cyan-600" :
                                 inputGradient === "dark-grey" ? "bg-gradient-to-r from-grey-700 to-grey-800" :
                                 ...
                                 inputGradient === "white-mode" ? "bg-gradient-to-r from-white-500 to-grey-300 text-black" :
                                 inputGradient === "purple-gold" ? "bg-gradient-to-r from-purple-500 to-yellow-600" :
                                 "bg-gradient-to-r from-blue-600 to-purple-600") : variants[variant],
        className
      )}
      onClick={onDismiss}
      {...props}
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center">
                      <span className={cn(
                        ...
                        inputGradient === "purple-gold" ? "text-purple-400" : 
                        "text-blue-400"
                      )}>title</span>
                      <Input
                        name="name"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center">
                      <span className={cn(
                        ...
                        inputGradient === "green-cyan" ? "text-green-400" : 
                        inputGradient === "dark-grey" ? "text-grey-400" : 
                        inputGradient === "red diagnose-orange" ? "text-red-400" : 
                        inputGradient === "retro-pink" ? "text-pink-400" : 
                        inputGradient === "retro-teal" ? "text-teal-400" : 
                        inputGradient === "white-mode" ? "text-grey-700" : 
                        inputGradient === "purple-gold" ? "text-purple-400" : 
                      ...
                      >
                        ...
                        <option value="purple-gold">Purple/Gold Glow</option>
                      </select>
                    </div>
                    <div className="text-sm text-gray-300 bg-gray-700/50 p-4 rounded-lg">
                      <h3 className={cn(
                        "text-lg font-semibold mb-1",
                        inputGradient === "grey-yellow" ? "bg-gradient-to-r from-grey-300 to-yellow-500 bg-clip-text text-transparent" :
                        ...
                        inputGradient === "dark-grey" ? "bg-gradient-to-r from-grey-500 to-grey-700 bg-clip-text text-transparent" :
                        ...
                        inputGradient === "white-mode" ? "bg-gradient-to-r from-grey-300 to-white-500 bg-clip-text text-transparent" :
                        inputGradient === "purple-gold" ? "bg-gradient-to-r from-purple-400 to-yellow-500 bg-clip-text text-transparent" :
