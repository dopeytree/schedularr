...
const CardTitle = ({ className, inputGradient, ...props }) => {
  ...
  return (
    <h3
      className={cn(
        "text-2xl font-semibold mb-1", // Reduced margin below h3
                ...
                <CardContent>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center">
                      <div className="w-10 flex-shrink-0"></div> {/* Placeholder for icon alignment */}
                      <Input
                        name="name"
                        value={event.name}
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative w-full">
                        <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white">
                          {currency.match(/[\p{Emoji}]/u) ? `${currency}x` : currency}
                        </span>
                        <Input
                          type="text"
                          value={cost || ''}
                          readOnly
                          placeholder="Fee"
                          className={cost ? 'text-white pl-10' : 'text-gray-400 pl-10'}
                          inputGradient={inputGradient}
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="text-sm text-gray-300 bg-gray-700/50 p-4 rounded-lg">
                      <h3 className={cn(
                        ...
                        inputGradient === "white-yellow" ? "bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text text-transparent" :
