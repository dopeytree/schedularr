...
const Button = ({ className, variant = "default", inputGradient, applyColor = true, ...props }) => {
  ...
  const variants = {
    ...
    gradient: applyColor ? (
      inputGradient === "grey-yellow" ? "bg-gradient-to-r from-gray-500 to-yellow-600 text-black hover:from-gray-600 hover:to-yellow-700 focus:ring-yellow-500 transform hover:scale-105" :
    ...
    gradientReverse: applyColor ? (
      inputGradient === "grey-yellow" ? "bg-gradient-to-l from-gray-500 to-yellow-600 text-black hover:from-gray-600 hover:to-yellow-700 focus:ring-yellow-500 transform hover:scale-105" :
      inputGradient === "green-cyan" ? "bg-gradient-to-l from-green-500 to-cyan-600 text-white hover:from-green-600 hover:to-cyan-700 focus:ring-green-500 transform hover:scale-105" :
      inputGradient === "dark-grey" ? "bg-gradient-to-l from-gray-700 to-gray-800 text-white hover:from-gray-800 hover:to-gray-900 focus:ring-gray-500 transform hover:scale-105" :
      inputGradient === "red-orange" ? "bg-gradient-to-l from-red-500 to-orange-600 text-white hover:from-red-600 hover:to-orange-700 focus:ring-red-500 transform hover:scale-105" :
      inputGradient === "retro-pink" ? "bg-gradient-to-l from-pink-500 to-purple-600 text-white hover:from-pink-600 hover:to-purple-700 focus:ring-pink-500 transform hover:scale-105" :
      inputGradient === "retro-teal" ? "bg-gradient-to-l from-teal-500 to-cyan-600 text-white hover:from-teal-600 hover:to-cyan-700 focus:ring-teal-500 transform hover:scale-105" :
      inputGradient === "brown-gold" ? "bg-gradient-to-l from-amber-900 to-yellow-600 text-white hover:from-amber-800 hover:to-yellow-700 focus:ring-amber-500 transform hover:scale-105" :
      inputGradient === "beige-grey" ? "bg-gradient-to-l from-gray-300 to-gray-500 text-black hover:from-gray-400 hover:to-gray-600 focus:ring-gray-400 transform hover:scale-105" :
...
const TabsTrigger = ({ value, onValueChange, tabValue, className, variant = "gradient", inputGradient, applyColor = true, ...props }) => {
...
const App = () => {
  ...
  const [applyButtonColors, setApplyButtonColors] = useState(() => {
    return localStorage.getItem('applyButtonColors') === 'true';
  });
  ...
  useEffect(() => {
    ...
    localStorage.setItem('applyButtonColors', applyButtonColors);
    localStorage.setItem('devMode', devMode);
  }, [isSignedIn, userEmail, userName, accessToken, hourlyRate, currency, whoWhat, calendarId, calendarName, inputGradient, applyButtonColors, devMode]);
  ...
  const handleApplyButtonColorsChange = (e) => {
    setApplyButtonColors(e.target.checked);
  };
        ...
        <>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="mb-6">
              <TabsTrigger tabValue="booking" value={activeTab} onValueChange={setActiveTab} variant="gradient" inputGradient={inputGradient} applyColor={applyButtonColors}>
                <span className="material-icons mr-2 transition-transform duration-300 hover:scale-125 p-1">event</span> Booking
              </TabsTrigger>
              <TabsTrigger tabValue="settings" value={activeTab} onValueChange={setActiveTab} variant="gradientReverse" inputGradient={inputGradient} applyColor={applyButtonColors}>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center w-full gap-[2px]">
                        ...
                        <Input
                          ...
                          readOnly
                          placeholder="Fee"
                          className={cn("w-4/5", cost ? 'text-white' : 'text-gray-400')}
                          inputGradient={inputGradient}
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={applyButtonColors}
                          onChange={handleApplyButtonColorsChange}
                          className="mr-2 rounded border-gray-600 bg-gray-800 text-blue-500 focus:ring-blue-500"
                        />
                        <span className="text-white">Apply Colors to Buttons</span>
                      </label>
                    </div>
                    <div className="text-center">
                      <Button
