...
const Button = ({ className, variant = "default", inputGradient, ...props }) => {
  ...
  const variants = {
    ...
    share: inputGradient === "white-yellow" ? "bg-gradient-to-r from-yellow-500 to-yellow-600 text-white hover:from-yellow-600 hover:to-yellow-700 focus:ring-yellow-500 transform hover:scale-105" :
...
const App = () => {
  ...
  }, [isSignedIn, userEmail, userName, accessToken, hourlyRate, currency, whoWhat, calendarId, inputGradient, devMode]);
                ...
                <CardContent>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative w-full">
                        <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white">{currency.match(/[\p{Emoji}]/u) ? `${currency}x` : currency}</span>
                        <Input
                          type="text"
                          value={cost ? `${cost}` : ''}
                          readOnly
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center">
                      ...
                      {calendarId ? (
                        <p className="text-white cursor-pointer hover:underline" onClick={openCalendarLink}>Schedularr</p>
                      ) : (
