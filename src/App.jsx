  ...
  return (
    <div className="relative w-full">
      <input
        ...
        style={{ boxShadow: gradientStyles[inputGradient] || gradientStyles['beige-grey'] }}
        onMouseEnter={(e) => e.target.style.boxShadow = hoverGradientStyles[inputGradient] || hoverGradientStyles['beige-grey']}
        onMouseLeave={(e) => e.target.style.boxShadow = gradientStyles[inputGradient] || gradientStyles['beige-grey']}
        {...props}
      />
    </div>
  );
  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        style={{ boxShadow: gradientStyles[inputGradient] || gradientStyles['beige-grey'], resize: 'none' }}
        onMouseEnter={(e) => e.target.style.boxShadow = hoverGradientStyles[inputGradient] || hoverGradientStyles['beige-grey']}
        onMouseLeave={(e) => e.target.style.boxShadow = gradientStyles[inputGradient] || gradientStyles['beige-grey']}
        {...props}
      />
  ...
  return (
    <h3
      className={cn(
        ...
        gradientStyles[inputGradient] || gradientStyles['beige-grey'],
        className
      )}
      {...props}
    />
...
const App = () => {
  ...
  const [inputGradient, setInputGradient] = useState(() => {
    return localStorage.getItem('inputGradient') || 'beige-grey';
  });
  const [buttonGradient, setButtonGradient] = useState(() => {
    return localStorage.getItem('buttonGradient') || 'blue-purple';
  });
  ...
  const handleSignIn = () => {
    ...
    if (!window.google || !window.google.accounts || !window.google.accounts.oauth2) {
      setSubmissionError('Google Identity Services not loaded. Please?).');
  ...
  // Check if Schedularr calendar exists, if not create one
  useEffect(() => {
    if (isSignedIn && !calendarId && !devMode && accessToken) {
      findSchedularrCalendar(accessToken).then(existingId => {
        if (existingId) {
          ...
          // Only create a new calendar if one doesn't exist
        ...
        setSubmissionError(`Error checking for existing calendar: ${err.message}`);
      });
    }
  ...
  const handleDefaultColors = () => {
    setInputGradient('beige-grey');
    setButtonGradient('blue-purple');
  };
          ...
          <div className="text-center">
            ...
            {showGuide && (
              <div className="text-sm text-gray-300 bg-gray-700/50 p-4 rounded-lg mt-2 text-left">
                ...
                <p className="mb-2 font-semibold">How to Rule the Scheduling Galaxy 🌀</p>
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>Troubleshooting (if things get pear shaped)—event not showing up? Double-check:</li>
                  ...
                  <li>Still lost? Check out <a href="https://support.google.com/calendar/answer/37082" target="_blank" className="text-blue-400 underline">Google Calendar Help</a> or <a href="https://developers.google.com/identity" target="_blank" className="text-blue-400 underline">Google Identity Docs</a> for extra wisdom.</li>
                </ol>
              </div>
            )}
                      ...
                      <div className="flex items-center w-full gap-[2px]">
                        ...
                        <div className="relative w-4/5">
                          <Input
                            ...
                            readOnly
                            placeholder="Fee"
                            className={cn("w-full cursor-pointer pr-12", cost ? 'text-white' : 'text-gray-400')}
                            inputGradient={inputGradient}
                            onClick={() => setActiveTab('settings')}
                          />
                    ...
                    {showBookingGuide && (
                      <div className="text-sm text-gray-300 bg-gray-700/50 p-4 rounded-lg mt-2 text-left">
                        ...
                        <ol className="list-decimal pl-5 space-y-2">
                          ...
                          <li>The calendar is shared with your account (don’t leave yourself out of the party).</li>
                          <li>Peek at console errors (F12 → Console) and share them with us if you’re stumped.</li>
                          <li>Still lost? Check out <a href="https://support.google.com/calendar/answer/37082" target="_blank" className="text-blue-400 underline">Google Calendar Help</a> for extra wisdom.</li>
                        </ol>
                      </div>
                    )}
                  </div>
